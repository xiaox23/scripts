...
class Realsense:
    def __init__(self, base_folder="data_save/vis_data", exp_number="0001"):
        ...
        # print(f"Data will be saved in: {self.data_folder}")
    ...
    def save_data(self, depth_image, color_image, color_timestamp):
        ...
        self.frame_count += 1
        # print(f"Saved frame {self.frame_count} to {file_path}")
...
def main():
    ...
    # 使用传入的文件夹路径和实验编号运行
    realsense = Realsense(base_folder=args.base_folder, exp_number=args.exp_number)
    realsense.run()

if __name__ == "__main__":
    main()

# python scripts/F02VisData.py --base_folder data_save/vis_data --exp_number 1